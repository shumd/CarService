package ru.shumilin.carService.worker.status.workStatus.service;

import lombok.AllArgsConstructor;
import lombok.NoArgsConstructor;
import org.springframework.stereotype.Service;
import ru.shumilin.carService.worker.status.workStatus.entity.WorkStatusEntity;
import ru.shumilin.carService.worker.status.workStatus.exception.WorkStatusNotFoundException;
import ru.shumilin.carService.worker.status.workStatus.repository.WorkStatusRepository;
